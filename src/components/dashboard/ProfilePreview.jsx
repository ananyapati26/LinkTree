...
import useLinksStore, { faIcons } from "@/store/useLinksStore";
...
const ProfilePreview = () => {
  ...
  return (
    <div className="p-4 rounded-lg bg-white shadow-md w-72 mx-auto">
      ...
      <div className="p-4 bg-gray-50 rounded-lg border shadow-md text-center">
        ...
        <div className="w-20 h-20 mx-auto mb-2">
          <Image src={profileImage} width={80} height={80} className="rounded-full" alt="Profile" />
        </div>
        ...
        <div className="mt-3 space-y-2">
          {links
            ...
            .map((link) => (
              <div key={link.id} className="bg-white border rounded-lg p-2 text-sm shadow-sm flex items-center gap-2">
                <FontAwesomeIcon icon={faIcons[link.icon]} className="text-gray-700 w-5 h-5" />
                <div>
